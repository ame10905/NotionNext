...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '72', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '遥か月を目指した今日の空は', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://weibo.com/u/7896294772', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '遥か月を目指した今日の空は,数多 星を降らした 夢じゃないや',
